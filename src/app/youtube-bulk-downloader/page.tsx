  ...
  return (
    <section className={`${styles.workbench} ${styles.mainContainer}`} aria-labelledby="bulk-title">
      ...
      <section className={`${styles.card} ${styles.green}`} aria-labelledby="url-title">
        <h2 id="url-title" className={styles.cardTitle}>Paste multiple video links 👇</h2>
        ...
        <p id="url-help" className={styles.helpText}>
          Paste one URL per line. Works with YouTube, Twitch, Dailymotion, BitChute, Rumble, and Streamable
        </p>
        ...
        <div className={styles.mt2}>
          ...
          >
            {processing ? 'Processing...' : 'Fetch All Thumbnails'}
          </button>
        </div>
      </section>
